          ...
          <div className="">
            <ul className="flex">
              <li
                ...
                onMouseOver={(e) => setProductTab(true)}
                onMouseLeave={(e) => setProductTab(false)}
              >
                Produkte
              </li>
              <li
                className="mr-8 text-lg nav_link"
                onMouseOver={(e) => setQualityTab(true)}
                onMouseLeave={(e) => setQualityTab(false)}
              >
                Qualität
              </li>
              <li
                className="mr-8 text-lg nav_link"
                onMouseOver={(e) => setServiceTab(true)}
                onMouseLeave={(e) => setServiceTab(false)}
              >
                Service
              </li>
